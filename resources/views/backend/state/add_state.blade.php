...
<div class="page-content">
        ...
        <div class="row profile-body">
          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
			...
			<h6 class="card-title">Add New State Area  </h6>
			...
			<form method="POST" action="{{ route('store.state') }}" class="forms-sample" enctype="multipart/form-data">
				...
				<div class="mb-3">
 <label for="exampleInputEmail1" class="form-label">State Area Name </label>
					 <input type="text" name="state_name" class="form-control " > 
				</div>

			 	<div class="mb-3">
 <label for="exampleInputEmail1" class="form-label">State Area Image </label>
