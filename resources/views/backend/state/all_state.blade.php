...
<div class="page-content">
				...
				<nav class="page-breadcrumb">
					<ol class="breadcrumb">
	  <a href="{{ route('add.state') }}" class="btn btn-inverse-info"> Add New State Area </a>
					</ol>
				</nav>
            ...
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">All State Areas</h6>
                ...
                <div class="table-responsive">
                  <table id="dataTableExample" class="table">
                    <thead>
                      <tr>
                        <th>Serial </th>
                        <th>State Area Name </th>
                        <th>State Area Image </th>
                        <th>Action </th> 
                      </tr>
                    </thead>
                    <tbody>
