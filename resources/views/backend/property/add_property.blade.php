...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="mb-3">
                <label class="form-label">Latitiude</label>
                <input type="text" name="latitude" class="form-control">
                <a href="https://www.latlong.net/convert-address-to-lat-long.html" target="_blank">Get Address Latitude</a>
            </div>
        </div><!-- Col -->
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                <a href="https://www.latlong.net/convert-address-to-lat-long.html" target="_blank">Get Address Longitude</a>
            </div>
        </div><!-- Col -->
    </div><!-- Row -->
...
<input type="checkbox" name="hot" value="1" class="form-check-input" id="checkInline">
        ...
        <!--   //////////// Property Sevices Option /////////////// -->

        <div class="row add_item">
            <div class="col-md-4">
                <div class="mb-3">
                        <label for="service_name" class="form-label">Property Benefit </label>
         ...
         <div class="container mt-2">
            <div class="row">
               ...
               <div class="form-group col-md-4">
                  <label for="service_name">Property Benefit</label>
                  <select name="service_name[]" id="service_name" class="form-control">
                        <option value="">Select Benefit</option>
                        <option value="Hospital">Hospital</option>
                        <option value="SuperMarket">Super Market</option>
