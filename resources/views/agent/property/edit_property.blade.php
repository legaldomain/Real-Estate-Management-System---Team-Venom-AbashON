...
<div class="page-content">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="mb-3">
                <label class="form-label">Property Facilities </label>
     <select name="facility_id[]" class="js-example-basic-multiple form-select" multiple="multiple" data-width="100%">
                ...
                <option value="{{ $facil->id }}" {{ (in_array($facil->id,$property_faci)) ? 'selected' : '' }} >{{ $facil->facility_name }}</option>
               @endforeach
...
<input type="checkbox" name="featured" value="1" class="form-check-input" id="checkInline1" {{ $property->featured == '1' ? 'checked' : '' }} >
         ...
         <div class="form-check form-check-inline">
<input type="checkbox" name="hot" value="1" class="form-check-input" id="checkInline" {{ $property->hot_exclusive == '1' ? 'checked' : '' }}>
...
<div class="page-content" style="margin-top: -35px;" > 
       ...
       <div class="card">
    <div class="card-body">
        <h6 class="card-title">Edit Property Benefits  </h6>
         ...
         <div class="container mt-2">
            <div class="row">
               ...
               <div class="form-group col-md-4">
                  <label for="servive_name">Benefits</label>
                  <select name="service_name[]" id="service_name" class="form-control">
    <option value="">Select Benefits</option>
    <option value="Hospital" {{ $item->service_name == 'Hospital' ? 'selected' : ''  }} >Hospital</option>
    <option value="SuperMarket" {{ $item->service_name == 'SuperMarket' ? 'selected' : ''  }}>Super Market</option>
    <option value="School" {{ $item->service_name == 'School' ? 'selected' : ''  }}>School</option>
    <option value="Entertainment" {{ $item->service_name == 'Entertainment' ? 'selected' : ''  }}>Entertainment</option>
    <option value="Pharmacy" {{ $item->service_name == 'Pharmacy' ? 'selected' : ''  }}>Pharmacy</option>
    <option value="Airport" {{ $item->service_name == 'Airport' ? 'selected' : ''  }}>Airport</option>
    <option value="Railways" {{ $item->service_name == 'Railways' ? 'selected' : ''  }}>Railways</option>
    <option value="Bus Stop" {{ $item->service_name == 'Bus Stop' ? 'selected' : ''  }}>Bus Stop</option>
    <option value="Beach" {{ $item->service_name == 'Beach' ? 'selected' : ''  }}>Beach</option>
    <option value="Mall" {{ $item->service_name == 'Mall' ? 'selected' : ''  }}>Mall</option>
    <option value="Bank" {{ $item->service_name == 'Bank' ? 'selected' : ''  }}>Bank</option>
                  </select>
               </div>
               <div class="form-group col-md-4">
      ...
      <div class="whole_extra_item_delete" id="whole_extra_item_delete">
         <div class="container mt-2">
            <div class="row">
               ...
               <div class="form-group col-md-4">
                  <label for="service_name">Benefits</label>
                  <select name="service_name[]" id="service_name" class="form-control">
                        <option value="">Select Property Benefits</option>
