                  ...
                  <div class="col-lg-3 border-end-lg">
                    <div class="d-flex align-items-center justify-content-between">
                      ...
                      <div class="order-first">
                        <h4>Mail Service</h4>
                        <p class="text-muted">support@abashon.com</p>
                      </div>
                    </div>
                    <div class="d-grid my-3">
                      <a class="btn btn-primary" href="./compose.html">Compose A Message</a>
                    </div>
                      ...
                      <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                          <div class="input-group">
                            <input class="form-control" type="text" placeholder="Search message...">
